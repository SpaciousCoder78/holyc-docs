...
*  See ![Scoping and Linkage](https://github.com/SpaciousCoder78/holyc-docs/blob/main/CompilerOverview/scopinglinkage.md) for details on `extern`, `import`, `_extern`, `_import`, etc.
